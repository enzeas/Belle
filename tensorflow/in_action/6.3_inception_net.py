...
def inception_v3_arg_scope(weight_decay=4e-5, stddev=0.1,
        ...
        with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
            ...
            with tf.variable_scope('Mixed_6a'):
                ...
                with tf.variable_scope('Branch_1'):
                    ...
                    branch_1 = slim.conv2d(branch_1, 96, [3, 3], stride=2, padding='VALID', scope='Conv2d_0c_1x1')
                with tf.variable_scope('Branch_2'):
            ...
            with slim.arg_scope([slim.conv2d, slim.max_pool2d, slim.avg_pool2d],
                ...
                with tf.variable_scope('AuxLogits'):
                    aux_logits = slim.avg_pool2d(aux_logits, [5, 5],
                            stride=3, padding='VALID', scope='AvgPoll_1a_5x5')
